...
const routes = [
  ...
  { path: '/update-profile', name: 'UpdateProfile', component: UpdateProfile, meta: { requiresAuth: true } },
  { path: '/admin-dashboard', name: 'AdminDashboard', component: AdminDashboard, meta: { requiresAuth: true, requiresAdmin: true } },
  { path: '/order-dashboard', name: 'OrderDashboard', component: OrderDashboard, meta: { requiresAuth: true, requiresManager: true } },
  { path: '/ai-dashboard', name: 'DashboardAi', component: DashboardAi, meta: { requiresAuth: true } },
  { path: '/work-hours', name: 'WorkHours', component: WorkHours, meta: { requiresAuth: true } },
];
...
router.beforeEach(async (to, from, next) => {
  ...
  if (requiresAuth && !isAuthenticated) {
    ...
    if (!isAuthenticated) {
      ...
      await aiStore.fetchUserData(auth.currentUser.uid);
      const userRole = aiStore.getUserRole;
